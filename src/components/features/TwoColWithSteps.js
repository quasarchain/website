...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Click Metamask",
      description: "Go to My Accounts > Settings > Networks > Add Network."
    },
    {
      heading: "Quasar Chain Mainnet",
      description: "Network Name: Quasar Chain Mainnet  New RPC URL: https://seed.quasarchain.org/  Chain ID: 27  Currency Symbol: QUASAR  Block Explorer URL: https://qsrscan.com/"
    },
    {
      heading: "Run",
