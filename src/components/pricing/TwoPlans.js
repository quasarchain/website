...
const Plan = styled.div`
  ${tw`w-full mt-16 md:mr-12 md:last:mr-0 px-8 rounded-lg relative text-gray-900 bg-white flex flex-col shadow-raised`}
  .planHighlight {
...
export default ({
  subheading = "Quasar Chain Network",
  heading = ".",
  description = "Go to My Accounts > Settings > Networks > Add Network.",
  plans = null,
  primaryButtonText = null,
}) => {
  const defaultPlans = [
    {
      name: "Quasar Chain Mainnet",
      features: ["Network Name: Quasar Chain Mainnet", "RPC URL: https://seed.quasarchain.org/", "Chain ID: 27", "Currency Symbol: QSR", "Block Explorer: https://qsrscan.com/"],
    },
    {
      name: "Quasar Chain Testnet",
      features: ["Network Name: Quasar Chain Testnet", "RPC URL: https://test.quasarchain.org/", "Chain ID: 28", "Currency Symbol: tQSR", "Block Explorer: https://testnet.qsrscan.com/"],
    },
  ];
